...
Theory:
---
1.	Get familiarized with Docker
2.	Micro services architecture and Docker
3.	Docker for test automation

Practice:
-----
1.	Run Selenium Grid with Docker
2.	Multi-container applications with Docker-compose
3.	Build your own image with tests
4.	Managing configuration files with Docker
5.	Dockerized tests and development pipeline
